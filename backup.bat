Infelizmente, não há um comando para elevar os privilégios no Windows, como um sudo no Unix, mas é possível sim. Logo abaixo, vou colocar o código com mais votos desta outra pergunta no SO:
